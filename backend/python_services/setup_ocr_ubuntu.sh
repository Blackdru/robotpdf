...
echo ""
echo "=== START OCR SERVER ==="
echo ""
echo "Option 1: Run manually (for testing):"
echo "  source $VENV_PATH/bin/activate"
echo "  python3 ocr_server.py"
echo ""
echo "Option 2: Install as systemd service (recommended for production):"
echo "  sudo cp ocr-server.service /etc/systemd/system/"
echo "  sudo systemctl daemon-reload"
echo "  sudo systemctl enable ocr-server"
echo "  sudo systemctl start ocr-server"
echo "  sudo systemctl status ocr-server"
echo ""
echo "=== ADD TO .env ==="
echo "OCR_SERVER_URL=http://127.0.0.1:5050"
echo ""
