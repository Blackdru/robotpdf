...
const PDFToExcelPrivacyPolicy = () => {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-6">Privacy Policy - PDF to Excel Converter</h1>
      <p className="text-sm text-gray-600 mb-8">Last Updated: December 2025</p>
      
      <section className="mb-6">
        <h2 className="text-2xl font-semibold mb-3">1. Introduction</h2>
        <p className="text-gray-700 mb-4">
          This Privacy Policy describes how PDF to Excel Converter ("we", "our", "us", or "the App") developed by 
      ...
      <section className="mb-6">
        ...
        <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4">
          <li><strong>Data Collected:</strong> PDF files you upload for Excel conversion</li>
          <li><strong>Purpose:</strong> To convert your PDF documents into Excel spreadsheet format</li>
        ...
        <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4">
          <li><strong>INTERNET:</strong> Required to upload PDF files to RobotPDF servers for processing</li>
          <li><strong>READ_EXTERNAL_STORAGE:</strong> Required to read PDF files from your device</li>
          <li><strong>WRITE_EXTERNAL_STORAGE:</strong> Required to save converted Excel files to your device</li>
        </ul>
      ...
      <section className="mb-6">
        ...
        <ul className="list-disc list-inside text-gray-700 space-y-2">
          <li>PDF files are uploaded to RobotPDF servers (app.robotpdf.com) via HTTPS/TLS encrypted connection</li>
          <li>Files are processed on our servers to extract data and convert to Excel format</li>
          <li>The converted Excel file is returned to your device immediately after processing</li>
      ...
      <section className="mb-6">
        ...
        <ul className="list-disc list-inside text-gray-700 space-y-2">
          ...
          <li><strong>Local Storage:</strong> Converted Excel files are saved to your device under your control</li>
      ...
      <section className="mb-6">
        ...
        <p className="text-gray-700 mb-4">
          PDF to Excel conversion is performed exclusively on RobotPDF servers (app.robotpdf.com). 
          PDF file content is processed only for conversion purposes and is not stored.
        </p>
...
export default PDFToExcelPrivacyPolicy;
