    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <section className="mb-6">
        ...
        <p className="text-gray-700 mb-4">
          This privacy policy applies to the PDF Merge App ("App") developed by RobotPDF. 
      ...
      <section className="mb-6">
        ...
        <p className="text-gray-700 mb-4">
          The PDF Merge App processes PDF files locally on your device to combine multiple PDFs into one. 
      ...
      <section className="mb-6">
        ...
        <ul className="list-disc list-inside text-gray-700 space-y-2">
          <li>Storage: To read and save merged PDF files</li>
        </ul>
      </section>
