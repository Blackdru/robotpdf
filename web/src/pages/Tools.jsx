...
const Tools = () => {
  ...
  const tools = [
    ...
    { id: 'word-to-pdf', icon: FileInput, title: 'Word to PDF', description: 'Convert Word documents to PDF format', path: '/word-to-pdf', solidColor: 'bg-indigo-600', category: 'Conversion', isFree: true, processingTime: '< 60s' },
    ...
    { id: 'excel-to-pdf', icon: Sheet, title: 'Excel to PDF', description: 'Convert Excel spreadsheets to PDF format', path: '/excel-to-pdf', solidColor: 'bg-green-600', category: 'Conversion', isFree: true, processingTime: '< 60s' },
